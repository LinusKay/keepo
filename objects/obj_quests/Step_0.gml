	...
	switch(i)
	{
		...
		case quest.test_out_your_dash:
			switch(grid[# 1, i])
				{
					case 0:
						event_fire(event.quest_start);
						event_register_script(event.player_dash_start, id, quest_dash);
						if global.quest_dash_test == true { 
							grid[# 1, i]++; 
							notification("QUEST UPDATED: " + string(grid[# 0, i]));
							}
					break;
					case 1:
						event_register_script(event.player_dash_gap_start, id, quest_dash_gap);
						if global.quest_dash_gap == true { 
							grid[# 1, i] = -1; 
							quest_rewards(grid, i);
							event_fire(event.quest_end);
			...
			switch(grid[# 1, i])
				{
					case 0:
						event_fire(event.quest_start);
						event_register_script(event.player_pick_up_item, id, quest_soup_time_get_soup)
					...
					break;
					case 1:
						event_register_script(event.player_gift_item, id, quest_soup_time_deliver_soup)
						if global.quest_soup_time_deliver_soup == true { 
							dialogue_responses("sleeves_soup_give");
							grid[# 1, i] = -1; 
							quest_rewards(grid, i);
							event_fire(event.quest_end);
							notification("QUEST COMPLETE: " + string(grid[# 0, i]));
			...
			switch(grid[# 1, i])
				{
					case 0:
						event_fire(event.quest_start);
						event_register_script(event.player_pick_up_item, id, quest_ravioli_rumble_get_recipe)
					...
					break;
					case 1:
						event_register_script(event.player_gift_item, id, quest_ravioli_rumble_deliver_recipe)
						if global.quest_ravioli_rumble_deliver_recipe == true { 
							dialogue_responses("luco_ravioli_3");
							grid[# 1, i] = -1; 
							quest_rewards(grid, i);
							event_fire(event.quest_end);
							notification("QUEST COMPLETE: " + string(grid[# 0, i]));
			...
			switch(grid[# 1, i])
				{
					case 0:
						event_fire(event.quest_start);
						event_register_script(event.player_pick_up_item, id, quest_mow_problem)
					...
					break;
					case 1:
						event_register_script(event.player_gift_item, id, quest_scents_deliver_nose)
						if global.quest_scents_deliver_nose == true { 
							dialogue_responses("old_man_accept_nose");
							grid[# 1, i] = -1; 
							quest_rewards(grid, i);
							event_fire(event.quest_end);
							notification("QUEST COMPLETE: " + string(grid[# 0, i]));
			...
			switch(grid[# 1, i])
				{
					case 0:
						event_fire(event.quest_start);
						event_register_script(event.outfit_change, id, quest_getting_fit)
			...
			switch(grid[# 1, i])
				{
					case 0:
						event_fire(event.quest_start);
						event_register_script(event.player_pick_up_item, id, quest_hotdog_hunt_get_dogs)
		...
		//			case 0:
		//				event_fire(event.quest_start);
		//				event_register_script(event.player_pick_up_item, id, quest_mow_problem_get_mower)
		...
		//				break;
		//			case 1:
		//				event_register_script(event.player_gift_item, id, quest_mow_problem_deliver_mower)
		//				if global.quest_mow_problem_deliver_mower == true { 
		//					dialogue_responses("tony_give_lawnmower");
		//					grid[# 1, i] = -1; 
		//					quest_rewards(grid, i);
		//					event_fire(event.quest_end);
		//					notification("QUEST COMPLETE: " + string(grid[# 0, i]));
